...
Every significant failure must produce two outputs:
1. Local correction of the current artifact or process.
2. A prevention improvement that reduces recurrence.
...
32.1 Locked CoreCycle Control Record
...
32.2 Mandatory Four-Question Checkpoint
...
32.3 Discovery Classification Gate
...
32.4 Complete Integrated Resolution
...
32.6 Drift Detection and Recovery
...
32.7 Successor Activation Gate
...
32.8 Completion and Responsibility Transfer


The Completion Contract in Section 12 is strengthened as follows:
...
32.9 Temporary-Context Exhaustion
...
32.10 Mechanical Enforcement Targets
