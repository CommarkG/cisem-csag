...
/* ---------- Mock data (loaded from the registry JSON directly) ---------- */
const MOCK_REGISTRY: Registry = {
  version: '1.1.0',
  templates: [
    {
      template_id: 'tpl_dashboard_grid_v1',
      canonical_name: 'Dashboard Grid',
      project_scope: 'ENTERPRISE_COMMERCE',
      page_type: 'DASHBOARD',
      version: '1.0.0',
      pe_priority_score: 8.5,
      status: 'VERIFIED',
      review_gate_status: 'PASSED',
      layout_contract: {
        direction_support: ['LTR', 'RTL'],
        density_modes: ['condensed', 'balanced', 'expansive'],
        component_blocks: ['HeaderHero', 'MetricRow', 'Table', 'ActionRail'],
      },
    },
    {
      template_id: 'tpl_catalog_table_v1',
      canonical_name: 'Catalog Table',
      project_scope: 'B2B_CATALOG',
      page_type: 'CATALOG',
      version: '1.0.0',
      pe_priority_score: 7.1,
      status: 'VERIFIED',
      review_gate_status: 'PASSED',
      layout_contract: {
        direction_support: ['LTR', 'RTL'],
        density_modes: ['condensed', 'balanced'],
        component_blocks: ['FilterBar', 'Search', 'Table'],
      },
    },
    {
      template_id: 'tpl_split_clarifier_v1',
      canonical_name: 'Split Clarifier',
      project_scope: 'ENTERPRISE_COMMERCE',
      page_type: 'WORKFLOW',
      version: '1.0.0',
      pe_priority_score: 7.8,
      status: 'DRAFT',
      review_gate_status: 'PASSED',
      layout_contract: {
        direction_support: ['LTR', 'RTL'],
        density_modes: ['balanced'],
        component_blocks: ['Sidebar', 'ContentPanel', 'Actions'],
      },
    },
    {
      template_id: 'tpl_b2b_interactive_quote_v1',
      canonical_name: 'B2B Interactive Quote & Proposal Shell',
      project_scope: 'ENTERPRISE_COMMERCE',
      page_type: 'INTERACTIVE_PROPOSAL',
      version: '1.0.0',
      pe_priority_score: 8.5,
      status: 'VERIFIED',
      review_gate_status: 'PASSED',
      layout_contract: {
        direction_support: ['LTR', 'RTL'],
        density_modes: ['condensed', 'balanced', 'expansive'],
        component_blocks: ['HeaderHero', 'HierarchicalBOM', 'DigitalSignatureCTA'],
      },
    },
  ],
  instantiated_pages: [
    {
      id: 'page-global-electronics-supplier',
      name: 'Global Electronics — Supplier View',
      template_id: 'tpl_catalog_table_v1',
      template_version_locked: '1.0.0',
      client_id: 'client-global-electronics',
      client_name: 'Global Electronics Ltd',
      status: 'active',
    ...
    {
      id: 'page-israel-metalworks-client',
      name: 'Israel Metalworks — Client Portal',
      template_id: 'tpl_dashboard_grid_v1',
      template_version_locked: '1.0.0',
      client_id: 'client-israel-metalworks',
      client_name: 'Israel Metalworks',
      status: 'active',
      custom_coding_allowed: false,
      governor_lock: true,
      created_at: '2026-08-11T00:00:00Z',
...
const CLIENT_LIST = [
  { id: 'client-global-electronics', name: 'Global Electronics Ltd' },
  { id: 'client-israel-metalworks', name: 'Israel Metalworks' },
  { id: 'client-tech-solutions', name: 'TechSolutions Corp' },
  { id: 'client-agro-industries', name: 'Agro Industries' },
];
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 20px', borderBottom: '1px solid var(--border)', background: 'var(--surface-elevated)', flexShrink: 0 }}>
        ...
        <span style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '3px 10px', borderRadius: 8,
          ...
          <User size={11} /> {simulatedRole.replace('_', ' ').toUpperCase()}
        </span>
        {!canDuplicate && (
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 5, padding: '3px 10px', borderRadius: 8,
                    ...
                    <div key={page.id}
                      ...
                      {!canDuplicate && (
                        <div style={{ width: '100%', display: 'flex', alignItems: 'center', gap: 6, padding: '6px 10px',
                          ...
                          <ShieldAlert size={12} /> Your role ({simulatedRole}) does not have write access to this page.
                        </div>
                      )}
                    </div>
                  );
