...
# version: V1.1
# reasoning: |
#   Hardens Hebrew UI alignment and fixed column sizing for administrative tables.
#   Utilizes dir='rtl' dynamically and converts tables to table-fixed.
      ...
      {activeCommentRow && (
        <AdminCommentPanel
          ...
          onAddComment={readOnly ? null : (text) => {
            ...
            const currentUser = useUIStore.getState().language === 'he' ? 'יריב' : 'Yariv';
