...
graph TD
    subgraph Python Scripts & Modules
        ...
        cisem_core\downloads\audit_all_references["cisem_core\downloads\audit_all_references.py"]
        cisem_core\downloads\audit_missing_ratified_docs["cisem_core\downloads\audit_missing_ratified_docs.py"]
        ...
        cisem_core\downloads\generate_backlog_seed["cisem_core\downloads\generate_backlog_seed.py"]
        cisem_core\downloads\generate_deduplicated_seed["cisem_core\downloads\generate_deduplicated_seed.py"]
        ...
        scratch\audit_all_references["scratch\audit_all_references.py"]
        scratch\audit_missing_ratified_docs["scratch\audit_missing_ratified_docs.py"]
        ...
        scratch\generate_deduplicated_seed["scratch\generate_deduplicated_seed.py"]
